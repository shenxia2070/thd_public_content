...
/* harmony export */ });
/* unused harmony exports createPortal, useNetTableKey, useRegisterForUnhandledEvent */
...
const OMGBP = () => {
    ...
    const [BpListAll, setBpListALl] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(undefined);
    ...
    (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.useGameEvent)('React_BP_Init', () => {
        // @ts-ignore
    ...
    (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.useGameEvent)('LuaDataToReact', 
    // debouncedHandler,
    () => {
        debouncedHandler();
    }, []);
    (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.useGameEvent)('LuaToReactFlash', data => {
        console.log('LuaToReactFlash');
        // @ts-ignore
        let panel = $(`#${data[1].panel_id}`);
        // @ts-ignore
        if (Game.GetLocalPlayerInfo().player_team_id == data[1].team) {
            if (panel) {
    ...
    const clickList = (Player_box_index, key_string, index, panel) => {
        ...
        //@ts-ignore
        const State = CustomNetTables.GetTableValue('react_table', 'react_table_state')[1];
        let team_tag = team == DOTATeam_t.DOTA_TEAM_GOODGUYS ? 'hakurei' : 'moriya';
        let enemy_team_tag = team == DOTATeam_t.DOTA_TEAM_GOODGUYS ? 'moriya' : 'hakurei';
        let BP_tag = 'BanList';
    ...
    const sendSwapButton = (Player_box_index, LocalPlayerBoxIndex) => {
        const BpListResultAll = CustomNetTables.GetTableValue('react_table', 'bp_list_result');
        const team = Game.GetLocalPlayerInfo().player_team_id;
    ...
    const agreeSwapButton = (Player_box_index, index) => {
    ...
    if (LocalPlayerInfo.player_id != -1 && LocalPlayerInfo.player_id != 23 && Game.GetMapInfo().map_name != `maps/dota.vpk`) {
        // if(false){
        invisAimPanel();
        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { className: "BP_HUD_box", children: new Array(5).fill(0).map((item, index) => {
                    return (BpListAll && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(PlayerBox, { Player_box_index: index + 1, bp_list_all: BpListAll }, `PlayerBox${index + 1}`));
                }) }) }));
    }
    else {
        //观战
        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { style: { width: '100%', height: '500px', backgroundColor: '#252525', marginTop: '20%', flowChildren: 'down' }, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { style: { width: '100%', height: '50px', verticalAlign: 'center', textAlign: 'center', fontSize: '80px', color: '#fff' }, text: `${State}` }) }) }));
    }
    function PlayerBox({ Player_box_index, bp_list_all }) {
        var _a, _b;
        // @ts-ignore
        var PlayerID;
        var EnemyID;
    ...
    function PlayerData({ Player_box_index, prosPlayerSteamID, PlayerID }) {
        ...
        return (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
            return (BpListResultAll && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { className: "my_player_data", style: { marginTop: State == 3 ? '20%' : '2px' }, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { style: { width: '100%', height: '50px', flowChildren: 'right' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(DOTAAvatarImage, { style: { width: '30px', height: '100%', marginLeft: '20%' }, steamid: PlayerSteamID }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(DOTAUserName, { className: "Player_box_element", style: { color: '#C0C0C0', marginLeft: '10px', horizontalAlign: 'left' }, steamid: PlayerSteamID })] }) })));
        }, [PlayerSteamID]);
    }
    function MyShowBox({ Player_box_index, prosMyHeroName, prosMyAbiName, prosMyUltName }) {
        var _a;
        const [myHeroName, setmyHeroName] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(prosMyHeroName);
        const [myAbiName, setmyAbiName] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(prosMyAbiName);
        const [myUltName, setmyUltName] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(prosMyUltName);
        ...
        return (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
            ...
            return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { className: "show_box", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { className: "hero_img_box", id: `${team_tag}_hero_${Player_box_index}`, onactivate: panel => panelFlash(panel, Player_box_index, team), children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(DOTAHeroMovie, { className: "hero_image_portrait", heroname: myHeroName }) }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { className: "ability_info", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { className: "hero_name", children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { className: "sub_label", text: text, style: { color: '#C0C0C0', fontSize: '15px' } }) }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { className: "show_ability_box", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { className: "ability", children: myAbiName && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(DOTAAbilityImage, { className: "ability", id: `${team_tag}_abi_${Player_box_index}`, showtooltip: true, abilityname: myAbiName, style: { width: '100%', height: '100%' }, onactivate: panel => {
                                                panelFlash(panel, Player_box_index, team);
                                            } }) }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { className: "ability", children: myUltName && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(DOTAAbilityImage, { className: "ability", id: `${team_tag}_ult_${Player_box_index}`, showtooltip: true, abilityname: myUltName, style: { width: '100%', height: '100%' }, onactivate: panel => {
                                                panelFlash(panel, Player_box_index, team);
                                            } }) })] })] })] }));
        }, [myHeroName, myAbiName, myUltName, State]);
    }
    function SelectBoxHero({ Player_box_index, PlayerID, propsMyBanHeroNumber, propsMyPickHeroNumber, propsEnemyBanHeroNumber }) {
        var _a, _b, _c;
        // console.log(`${Player_box_index}盒子的propsMyBanHeroNumber是${propsMyBanHeroNumber}`);
        const [myBanHeroNumber, setmyBanHeroNumber] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(propsMyBanHeroNumber);
        const [myPickHeroNumber, setmyPickHeroNumber] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(propsMyPickHeroNumber);
        const [enemyBanHeroNumber, setenemyBanHeroNumber] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(propsEnemyBanHeroNumber);
        //@ts-ignore
        const State = (_a = (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.useNetTableValues)('react_table')) === null || _a === void 0 ? void 0 : _a.react_table_state[1];
        const bpListAll = (_b = (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.useNetTableValues)('react_table')) === null || _b === void 0 ? void 0 : _b.bp_list_all;
        const BpListResultAll = (_c = (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.useNetTableValues)('react_table')) === null || _c === void 0 ? void 0 : _c.bp_list_result;
        ...
        return (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
            ...
            return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { className: "select_box div_1", style: { visibility: State == 3 ? 'collapse' : 'visible' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { className: "sub_label", style: { color: '#C0C0C0' }, text: '少女' }), new Array(6).fill(0).map((item, index) => {
                        let ban_class_name = '';
                        ...
                        return (hero_list[index + 1] && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Image, { id: `${key_hero}_${Player_box_index}_${index + 1}`, className: `hero_image ${ban_class_name} ${ability_class_name}`, src: `s2r://panorama/images/heroes/thd2_${hero_list[index + 1]}_png.vtex`, onactivate: panel => clickList(Player_box_index, key_hero, index + 1, panel) }, `${key_hero}_${Player_box_index}_${index + 1}`)));
                    })] }));
        }, [myBanHeroNumber, myPickHeroNumber, enemyBanHeroNumber, State]);
    }
    function SelectBoxAbi({ Player_box_index, PlayerID, propsMyBanNumber, propsMyPicNumber, propsEnemyBanNumber, key_type }) {
        var _a, _b;
        const [myBanNumber, setmyBanNumber] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(propsMyBanNumber);
        const [myPickNumber, setmyPickNumber] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(propsMyPicNumber);
        const [enemyBanNumber, setenemyAbiNumber] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(propsEnemyBanNumber);
        //@ts-ignore
        const State = (_a = (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.useNetTableValues)('react_table')) === null || _a === void 0 ? void 0 : _a.react_table_state[1];
        const bpListAll = (_b = (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.useNetTableValues)('react_table')) === null || _b === void 0 ? void 0 : _b.bp_list_all;
        ...
        return (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
            return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { className: "select_box div_2", style: { visibility: State == 3 ? 'collapse' : 'visible' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { className: "sub_label", style: { color: '#C0C0C0' }, text: '普通技能' }), new Array(8).fill(0).map((item, index) => {
                        let ban_class_name = '';
                        let ability_class_name = '';
                        if (State == 1) {
                            // Ban人状态下只显示自己ban的技能
                        ...
                        return (abi_list[index + 1] && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(DOTAAbilityImage, { id: `${key_type}_${Player_box_index}_${index + 1}`, className: `ability ${ban_class_name} ${ability_class_name}`, showtooltip: true, abilityname: abi_list[index + 1], onactivate: panel => clickList(Player_box_index, key_type, index + 1, panel) }, `${key_type}_${Player_box_index}_${index + 1}`)));
                    })] }));
        }, [myBanNumber, myPickNumber, enemyBanNumber, State]);
    }
    function EnemyShowBox({ Player_box_index, prosEnemyHeroName, prosEnemyAbiName, prosEnemyUltName }) {
        var _a;
        // console.log("这是ShowBox组件渲染");
        const [enemyHeroName, setenemyHeroName] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(prosEnemyHeroName);
        const [enemyAbiName, setenemyAbiName] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(prosEnemyAbiName);
        const [enemyUltName, setenemyUltName] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(prosEnemyUltName);
        const team = Game.GetLocalPlayerInfo().player_team_id;
        const enemy_team_tag = team == DOTATeam_t.DOTA_TEAM_GOODGUYS ? 'moriya' : 'hakurei';
        // @ts-ignore
        const State = (_a = (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.useNetTableValues)('react_table')) === null || _a === void 0 ? void 0 : _a.react_table_state[1];
        ...
        return (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
            return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { className: "show_box", style: { visibility: State == 3 ? 'visible' : 'collapse' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { className: "hero_img_box", id: `${enemy_team_tag}_hero_${Player_box_index}`, onactivate: panel => panelFlash(panel, Player_box_index, team), children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(DOTAHeroMovie, { className: "hero_image_portrait", heroname: enemyHeroName }) }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { className: "ability_info", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { className: "hero_name", children: enemyHeroName && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { className: "sub_label", text: $.Localize(`#${enemyHeroName}`), style: { color: '#C0C0C0', fontSize: '15px' } })) }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { className: "show_ability_box", children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { className: "ability", children: enemyAbiName && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(DOTAAbilityImage, { className: "ability", id: `${enemy_team_tag}_abi_${Player_box_index}`, showtooltip: true, abilityname: enemyAbiName, style: { width: '100%', height: '100%' }, onactivate: panel => panelFlash(panel, Player_box_index, team) })) }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { className: "ability", children: enemyUltName && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(DOTAAbilityImage, { className: "ability", id: `${enemy_team_tag}_ult_${Player_box_index}`, showtooltip: true, abilityname: enemyUltName, style: { width: '100%', height: '100%' }, onactivate: panel => panelFlash(panel, Player_box_index, team) })) })] })] })] }));
    ...
    function panelFlash(panel, Player_box_index, team) {
        // if (panel) {
        // panel.RemoveClass('flash');
        // panel.AddClass('flash');
        // }
