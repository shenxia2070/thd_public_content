...
/* harmony export */ });
/* unused harmony exports createPortal, useGameEvent, useNetTableKey, useNetTableValues */
...
const ExtraScepterPanel = (props) => {
    const [hasScepter, setHasScepter] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    const [hasShard, setHasShard] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        const DisplayPanel = DOTAHud.FindChildTraverse('AghsStatusContainer');
        setInterval(() => {
            setHasScepter(DisplayPanel.BHasClass('HasScepter'));
            setHasShard(DisplayPanel.BHasClass('HasShard'));
        }, 2000);
    }, []);
    const [abi, setabi] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(props.initabi);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        props.parent.GetParent().MoveChildAfter(DOTAHud.FindChildTraverse('ExtraScepterUpgradeDescription'), props.parent);
        DOTAHud.FindChildTraverse('ScepterUpgradeDescription').visible = false;
        DOTAHud.FindChildTraverse('ShardUpgradeDescription').visible = false;
    }, []);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        if (abi == 'item_shanyaozhixin') {
            DOTAHud.FindChildTraverse('DOTAAbilityTooltip').FindChildTraverse('ItemSubtitle').style.visibility = 'visible';
            //@ts-ignore
            DOTAHud.FindChildTraverse('AbilityDetails').SetDialogVariable('item_subtitle', `光环： 无法关闭`);
        }
        else {
            DOTAHud.FindChildTraverse('DOTAAbilityTooltip').FindChildTraverse('ItemSubtitle').style.visibility = DOTAHud.FindChildTraverse('AbilityDetails').BHasClass('ShowItemSubtitle') ? 'visible' : 'collapse';
        }
    }, [abi]);
    const [scep, sscep] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        const scepterText = `#DOTA_Tooltip_ability_${abi}_scepter_Description`;
        const localizedScepterText = $.Localize(scepterText);
        if (localizedScepterText == scepterText) {
            sscep(false);
            return;
        }
        sscep(true);
    }, [abi]);
    const [shard, sshard] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        const shardText = `#DOTA_Tooltip_ability_${abi}_shard_Description`;
        const localizedShardText = $.Localize(shardText);
        if (localizedShardText == shardText) {
            sshard(false);
            return;
        }
        sshard(true);
    }, [abi]);
    const fixed = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(false);
    // 公共的tooltip处理函数，保留先隐藏后显示机制
    const handleTooltipShow = (abilityName, redispatchEvent) => {
        if (fixed.current) {
            fixed.current = false;
        }
        else {
    ...
    (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.useRegisterForUnhandledEvent)('DOTAShowAbilityTooltip', (_, ability) => {
        handleTooltipShow(ability, () => {
            $.DispatchEvent('DOTAShowAbilityTooltip', _, ability);
        });
    }, []);
    (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.useRegisterForUnhandledEvent)('DOTAShowAbilityTooltipForEntityIndex', (_, ability, entity) => {
        handleTooltipShow(ability, () => {
            $.DispatchEvent('DOTAShowAbilityTooltipForEntityIndex', _, ability, entity);
        });
    }, []);
    (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.useRegisterForUnhandledEvent)('DOTAShowAbilityInventoryItemTooltip', (_, entity, idx) => {
        handleTooltipShow(Abilities.GetAbilityName(Entities.GetItemInSlot(entity, idx)) || '', () => {
            $.DispatchEvent('DOTAShowAbilityInventoryItemTooltip', _, entity, idx);
        });
    }, []);
    (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.useRegisterForUnhandledEvent)('DOTAHideAbilityTooltip', () => {
        if (!fixed.current) {
            setabi('');
        }
    }, []);
    return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { id: `ExtraScepterUpgradeDescription`, style: { flowChildren: 'down' }, children: [scep &&
                (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { style: { border: '1px solid black', width: '340px', minHeight: '40px', flowChildren: 'down', marginLeft: '2px', backgroundImage: 'url("s2r://panorama/images/hud/aghs_tooltip_bg_psd.vtex")' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { style: { height: '46px' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { style: { width: '34px', height: '34px', backgroundImage: `url("s2r://panorama/images/hud/reborn/aghsstatus_scepter${hasScepter ? '_on' : ''}_psd.vtex")`, backgroundSize: '100%', marginTop: '4px', marginLeft: '4px' } }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { text: '万宝槌升级', style: { align: 'left center', marginLeft: '40px', fontSize: '20px', fontWeight: 'semi-bold', color: 'gradient( linear, 0% 0%, 40% 0%, from( #92acf5 ), to(#6378b3 ) )', textShadow: '2px 2px 0px #000000' } })] }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { style: { minHeight: '50px', marginTop: '2px', flowChildren: 'down' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { style: { width: '2px', height: '6px' } }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { text: GameUI.ReplaceDOTAAbilitySpecialValues(abi, $.Localize(`#DOTA_Tooltip_ability_${abi}_scepter_Description`)), html: true, style: { align: 'left top', whiteSpace: 'normal', color: '#9ab0cd', fontSize: '16px', marginLeft: '6px' } }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { style: { width: '2px', height: '6px' } })] })] }), shard &&
                (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { style: { border: '1px solid black', width: '340px', minHeight: '40px', flowChildren: 'down', marginLeft: '2px', backgroundImage: 'url("s2r://panorama/images/hud/aghs_tooltip_bg_psd.vtex")' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { style: { height: '46px' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { style: { width: '34px', height: '18px', backgroundImage: `url("s2r://panorama/images/hud/reborn/aghsstatus_shard${hasShard ? '_on' : ''}_psd.vtex")`, backgroundSize: '100%', marginTop: '14px', marginLeft: '4px' } }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { text: '阿哈利姆魔晶', style: { align: 'left center', marginLeft: '40px', fontSize: '20px', fontWeight: 'semi-bold', color: 'gradient( linear, 0% 0%, 40% 0%, from( #92acf5 ), to(#6378b3 ) )', textShadow: '2px 2px 0px #000000' } })] }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, { style: { minHeight: '50px', marginTop: '2px', flowChildren: 'down' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { style: { width: '2px', height: '6px' } }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { text: GameUI.ReplaceDOTAAbilitySpecialValues(abi, $.Localize(`#DOTA_Tooltip_ability_${abi}_shard_Description`)), html: true, style: { align: 'left top', whiteSpace: 'normal', color: '#9ab0cd', fontSize: '16px', marginLeft: '6px' } }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { style: { width: '2px', height: '6px' } })] })] }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, { style: { width: '2px', height: '10px' } })] });
};
if (DOTAHud.FindChildTraverse('ExtraScepterUpgradeDescription')) {
    DOTAHud.FindChildTraverse('ExtraScepterUpgradeDescription').DeleteAsync(0);
}
const f = () => {
    $.Schedule(0.1, () => {
        const scepterPanel = DOTAHud.FindChildTraverse('ScepterUpgradeDescription');
        if (scepterPanel) {
            (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.render)((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ExtraScepterPanel, { initabi: '', parent: scepterPanel }), scepterPanel.GetParent());
        }
        else {
            f();
        }
...
f();
if (DOTAHud.FindChildTraverse('ExtraAghsTooltips')) {
    DOTAHud.FindChildTraverse('ExtraAghsTooltips').DeleteAsync(0);
}
